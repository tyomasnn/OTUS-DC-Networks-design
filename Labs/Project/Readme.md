...
### Цель:
- Разработка и моделирование сетевой архитектуры CLOS с использованием VXLAN/EVPN фабрик обеспечивающего L2/L3 транспорт для ПАК накопления статистической информации и содержимого, размещенного в двух георазнесенных ЦОД с возможностью бесшовного масштабирования на большее колличество ЦОД.
