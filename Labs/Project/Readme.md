...
При расширении ПАК и выносе сегментов в новые ЦОДы топология легко может масштабироваться при подключении сегментов расширения ПАК к действующим RouteServer-ам и их включением в Multisite.
